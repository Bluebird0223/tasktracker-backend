...
const uploadVideoAndImage = multer({ storage: multerStorage, limits: { fileSize: multerUtils?.MULTER_UPLOAD_VIDEO_SIZE_LIMIT }, fileFilter: multerUtils?.multerFileTypeFilterForImageAndVideo });
