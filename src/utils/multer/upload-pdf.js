...
const uploadPdf = multer({ storage: multerStorage, limits: { fileSize: multerUtils?.MULTER_UPLOAD_FILE_SIZE_LIMIT }, fileFilter: multerUtils?.multerFileTypeFilterForPdf })
